...
public class PlayerStats : MonoBehaviour
{
    ...
    public void RestStamina(float amount)
    {
        ...
        GameManager.instance.ShowMessageText($"Enerji +{amount}");
        ClampValues();
    }
    ...
    public void RestSanity(float amount)
    {
        ...
        GameManager.instance.ShowMessageText($"Akýl Saðlýgý +{amount}");
        ClampValues();
    }
    ...
    public void EatFood(float amount)
    {
        ...
        GameManager.instance.ShowMessageText($"Yemek +{amount}");
        ClampValues();
    }
    #endregion
